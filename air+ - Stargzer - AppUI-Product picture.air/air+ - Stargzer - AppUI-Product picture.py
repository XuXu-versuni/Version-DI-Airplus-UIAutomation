...
#检查设备产品图片显示
assert_exists(Template(r"tpl1733302396807.png", record_pos=(-0.326, 0.014), resolution=(1440, 3088)), "产品图片显示正确")
sleep(1)
...
#检查设备产品图片显示
assert_exists(Template(r"tpl1733302877614.png", record_pos=(0.335, -0.634), resolution=(1440, 3088)), "产品图片显示正确")
sleep(2)

...
"""本shell 对应 测试用例：https://nutriu.atlassian.net/browse/CH-2827
   下列20到74行对应 测试用例：https://nutriu.atlassian.net/browse/CH-2827
"""
# 打开 Air+ App
poco(text="Air+").click()
sleep(10)
...
#向下滑动
swipe(Template(r"tpl1736236409204.png", record_pos=(-0.203, -0.787), resolution=(1440, 3088)), vector=[0.0608, 0.4771])
